...
howUse.addEventListener('click', () => {
    ...
    <div class="modal">
        <div class="howItWorks">
            <div class="textModal">
                <h4>Aquí le enseñamos como economizar hasta $1.870,- usando los 6 cupones existentes ($ 20 /50 /100 /200 /500 /1.000) como si fueran dinero en la Verdulería, Panadería, etc.</h4>
                <br>
                <h5>¿Cómo hacerlo? </h5>
